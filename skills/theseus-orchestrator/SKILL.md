...
> | 10 스프린트 | intent-plan-impl-sprint-trinity · grader-in-sprint · **regression §2** (sprint loop, sprint-37 PR-AE 통합) · budget-saturation-loop · sprint-score-delta-tracking · evidence-driven-sprint-planning · cross-universe-lesson-distillation · **regression-tdd-gate** (sprint-34, sprint iteration trigger) |
