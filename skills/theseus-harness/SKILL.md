...
version: 0.9.18
description: 재귀 멀티 에이전트 코딩 하네스 — 15 페이즈 / 51 컨벤션 / 18 에이전트. AIDE 멀티버스 + 발현 검증 + Layer 3 결과물 허들 + grade_assess v2 + intent §k 9 sub + cycle coherence + domain failure patterns + decision-support framing (v0.9.18).
---
