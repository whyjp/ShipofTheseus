...
ai- **Deep semantic intent — adjective + noun 결합 implied framing 추출 (v0.9.13 신규, ceiling-breaking 1순위)**: [`conventions/deep-semantic-intent.md`](conventions/deep-semantic-intent.md)
