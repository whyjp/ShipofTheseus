...
version: 0.9.19
description: 재귀 멀티 에이전트 코딩 하네스 — 15 페이즈 / 55 컨벤션 / 18 에이전트. AIDE 멀티버스 (G3=5/G4=7/G5=9 폭 default) + 발현 검증 + Layer 3 결과물 허들 + grade_assess v2 + intent §k 9 sub + cycle coherence + domain failure patterns + decision-support framing + v0.9.19 sprint-13 (mindmap A default / per-module diagram / multiverse width bump / sprint trinity 3 axis × ≥2).
---
