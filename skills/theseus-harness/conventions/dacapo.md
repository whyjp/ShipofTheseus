...
| **Debug** | 실패 분석 + 수정 (회귀 바이섹트 + 정체 rewrite) | [`../phases/11-regression-bisect.md`](../phases/11-regression-bisect.md) + [`sprint-narrative.md`](sprint-narrative.md) §4 `rewrite_module` |
| **Memory** | 과거 시도 요약 주입 — lesson_pack | [`sprint-narrative.md`](sprint-narrative.md) §4 `lesson_pack` (모든 sprint 첨부) |
...
| 2- 해결 (fix) | [`../phases/11-regression-bisect.md`](../phases/11-regression-bisect.md) 권고 + [`sprint-narrative.md`](sprint-narrative.md) §4 rewrite |
| 3- 레슨 추출 (extract) | [`sprint-narrative.md`](sprint-narrative.md) §4 `lesson_pack` 형식 |
| 4- 방어 테스트 (defense) | 본 컨벤션 §"방어 테스트" (신규 정의) — [`sprint-narrative.md`](sprint-narrative.md) §4 lesson_pack 의 `defense_test` 필드 확장 |
...
b- **위키 업데이트** — 다음 셋 중 하나 이상:
  b-1 `lesson_pack.json` (sprint NN — [`sprint-narrative.md`](sprint-narrative.md) §4)
...
**해결** — [`sprint-narrative.md`](sprint-narrative.md) §4 의 `lesson_pack` 구조에 다음 필드 추가:
