...
a- **ensemble 의 cherry-picking** — 약한 sub-component 도 winner 의 것으로 채택 (모든 dimension 같은 universe). v0.9.10 [`tournament-blind-rerun.md`](tournament-blind-rerun.md) §6-d 와 동일 강등 — 강제 분포 대신 *origin 분포 측정·보고* carry.
