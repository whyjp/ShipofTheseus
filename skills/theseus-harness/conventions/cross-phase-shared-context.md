...
| **Module interface signatures** | `plan/06-plan.md` § Module interfaces (canonical, phase 06 §canonical inline 의무, sprint-37 PR-AH) | 08 impl |
...
2. phase 06 canonical 06-plan.md 가 stub 인 채 phase 08 가 universe-N 직접 인용 → phase 06 §canonical inline (sprint-37 PR-AH) 과 결합 fail.
...
- phases/06,08,14 §canonical inline (sprint-37 PR-AH, prev: canonical-not-stub.md cg) — canonical 위치가 본 룰의 단일 위치 역할.
