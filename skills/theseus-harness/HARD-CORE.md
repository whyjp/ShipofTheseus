...
본 파일 = 9.a~c 본문 의무만 inline. 9.d/9.f/9.mm/9.nn/9.oo/9.pp/9.bbb~9.jjj/9.kkk~9.mmm/9.nnn~9.ppp (sprint-34~52, 30+ sub-rule) 전문은 [`conventions/hard-rule-9-extended.md`](conventions/hard-rule-9-extended.md) 단일 source — 페이즈 진입 시 매칭 lazy load.
